 ...
 * is passed, so the ThemeProvider enables them all), and the first-visit shuffle
 * pool is derived from the gallery directory. So the only thing left to curate is
 * which theme a brand-new visitor lands on as the structural default.
 */
