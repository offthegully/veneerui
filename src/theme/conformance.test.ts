...
/**
 * Every non-test source file under src, as raw text. Vite's import.meta.glob
 * reads them at transform time, so this needs no Node fs APIs (and the app
 * tsconfig stays free of node globals). Keys are paths relative to this file.
 */
